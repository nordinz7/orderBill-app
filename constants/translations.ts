...
const en = {
  ...
  totalOverdueAmount: (amount: number, currency: string) => `${currency}${amount.toLocaleString()} overdue`,
  ...
  includeCountryCode: 'Enter mobile number. Country code is added automatically.',
  save: 'Save Customer',
  saveOrder: 'Save Order',
  duplicateOrderTitle: 'Order Already Exists',
  duplicateOrderMsg: (name: string, qty: number) => `${name} already has an order for today (${qty}). Do you want to edit the existing order?`,
  ...
  backupTables: 'Select tables',
  backupTablesHint: 'These tables will be included when exporting or importing a backup.',
  chooseTablesForExport: 'Choose tables to export',
  chooseTablesForImport: 'Choose tables to import',
  customersTable: 'Customers',
  ordersTable: 'Orders',
  transactionsTable: 'Transactions',
  noTablesSelected: 'Select at least one table.',
  importBackup: 'Import Backup',
  saveBackupHint: 'Creates a backup file. Choose where to save it — Google Drive, WhatsApp, Files, or any app.',
  autoBackupsInfo: (count: number, oldest: string) => count > 0 ? `${count} auto-backup${count === 1 ? '' : 's'} (oldest: ${oldest})` : 'No auto-backups yet',
  restoreFromAutoBackup: 'From Auto-backups',
  restoreFromFile: 'From File',
  chooseRestoreSource: 'Restore from where?',
  chooseBackupToRestore: 'Choose a backup to restore',
  ...
  restoreDesc: 'Pick a previously exported .json backup file. Only the selected tables will be imported.',
  ...
  restoreFailedMsg: 'The selected file is not a valid backup.',
  restoreConfirm: 'Confirm Restore',
  restoreConfirmMsg: 'This will REPLACE all existing data with the backup. Are you sure?',
  restoreSelectedConfirmMsg: 'This will import and update only the selected tables. Are you sure?',
  restoring: 'Restoring...',
  proceed: 'Proceed',
  // Backup plan info
  ...
  // Invoice labels
  invoiceTitle: (company: string) => company ? `${company} — Invoice` : 'Invoice',
  ...
  statementTitle: (company: string) => company ? `${company} — Statement` : 'Statement',
  ...
  companyNamePlaceholder: 'e.g. ABC FOODS',
  companyPlacePlaceholder: 'e.g. Chennai',
  ...
  noBulkAmounts: 'No amounts entered. Enter at least one amount to save.',
  ...
  defaultOrderDescPlaceholder: 'e.g. Rice, Bread, etc.',
  // Regional
  ...
  lock: 'Lock',
  unlock: 'Unlock',
  lockedNotice: 'Locked — the date has passed.',
  cannotEditLocked: 'This is locked because its date has passed. Unlock it first to make changes.',
  unlockConfirm: 'Unlock?',
  unlockConfirmMsg: 'Unlocking lets this be edited or deleted again. Continue?',
  lockConfirm: 'Lock?',
  lockConfirmMsg: 'Locking prevents any further edits until you unlock it. Continue?',
  // Payment receipt
...
const ta: typeof en = {
  ...
  totalOverdueAmount: (amount: number, currency: string) => `${currency}${amount.toLocaleString()} நிலுவை`,
  ...
  amount: 'தொகை',
  description: 'விவரம்',
  includeCountryCode: 'மொபைல் எண்ணை உள்ளிடவும். நாட்டு குறியீடு தானாக சேர்க்கப்படும்.',
  ...
  phonePlaceholder: 'எ.கா. 1234567890',
  ...
  saveBackup: 'காப்பை சேமி',
  backupTables: 'அட்டவணைகளைத் தேர்வு செய்',
  backupTablesHint: 'காப்பை ஏற்றுமதி அல்லது இறக்குமதி செய்யும்போது இந்த அட்டவணைகள் பயன்படுத்தப்படும்.',
  chooseTablesForExport: 'ஏற்றுமதி செய்ய அட்டவணைகளைத் தேர்வு செய்',
  chooseTablesForImport: 'இறக்குமதி செய்ய அட்டவணைகளைத் தேர்வு செய்',
  customersTable: 'வாடிக்கையாளர்கள்',
  ordersTable: 'ஆர்டர்கள்',
  transactionsTable: 'பரிவர்த்தனைகள்',
  noTablesSelected: 'குறைந்தது ஒரு அட்டவணையையாவது தேர்வு செய்யவும்.',
  importBackup: 'காப்பை இறக்குமதி செய்',
  saveBackupHint: 'காப்பு கோப்பை உருவாக்குகிறது. Google Drive, WhatsApp, Files அல்லது வேறு எங்கும் சேமிக்கலாம்.',
  autoBackupsInfo: (count: number, oldest: string) => count > 0 ? `${count} தானியங்கி காப்பு${count === 1 ? '' : 'கள்'} (பழையது: ${oldest})` : 'தானியங்கி காப்புகள் இல்லை',
  restoreFromAutoBackup: 'தானியங்கி காப்பிலிருந்து',
  restoreFromFile: 'கோப்பிலிருந்து',
  chooseRestoreSource: 'எங்கிருந்து மீட்டெடுக்க?',
  chooseBackupToRestore: 'மீட்டெடுக்க காப்பை தேர்வு செய்யுங்கள்',
  ...
  restoreDesc: 'முன்பு ஏற்றுமதி செய்த .json காப்பு கோப்பை தேர்ந்தெடுக்கவும். தேர்ந்தெடுத்த அட்டவணைகள் மட்டும் இறக்குமதி செய்யப்படும்.',
  ...
  restoreFailedMsg: 'தேர்ந்தெடுக்கப்பட்ட கோப்பு சரியான காப்பு அல்ல.',
  restoreConfirm: 'மீட்டெடுப்பை உறுதிப்படுத்து',
  restoreConfirmMsg: 'இது இருக்கும் அனைத்து தரவையும் காப்புடன் மாற்றும். உறுதியா?',
  restoreSelectedConfirmMsg: 'தேர்ந்தெடுக்கப்பட்ட அட்டவணைகள் மட்டும் இறக்குமதி செய்யப்படும். உறுதியா?',
  ...
  invoiceTitle: (company: string) => company ? `${company} — விலைப்பட்டியல்` : 'விலைப்பட்டியல்',
  ...
  statementTitle: (company: string) => company ? `${company} — அறிக்கை` : 'அறிக்கை',
  ...
  companyNamePlaceholder: 'எ.கா. ABC FOODS',
  companyPlacePlaceholder: 'எ.கா. சென்னை',
  ...
  noBulkAmounts: 'தொகை எதுவும் உள்ளிடவில்லை. சேமிக்க குறைந்தது ஒரு தொகையை உள்ளிடவும்.',
  ...
  defaultOrderDescPlaceholder: 'எ.கா. அரிசி, ரொட்டி, போன்றவை',
  // Regional
  ...
  lock: 'பூட்டு',
  unlock: 'திற',
  lockedNotice: 'பூட்டப்பட்டது — தேதி கடந்துவிட்டது.',
  cannotEditLocked: 'தேதி கடந்துவிட்டதால் இது பூட்டப்பட்டுள்ளது. மாற்ற முதலில் திறக்கவும்.',
  unlockConfirm: 'திறக்கவா?',
  unlockConfirmMsg: 'திறந்தால் இதை மீண்டும் திருத்தவோ நீக்கவோ முடியும். தொடரவா?',
  lockConfirm: 'பூட்டவா?',
  lockConfirmMsg: 'பூட்டினால் நீங்கள் திறக்கும் வரை எந்த மாற்றமும் செய்ய முடியாது. தொடரவா?',
  // Payment receipt
